...
import project2 from '../assets/project_portfolio0.png'
...
const projects = [
  {
    ...
    img: [ { id: 0, img: project0 }, { id: 1, img: project01 }, { id: 2, img: project02 } ]
  },
  {
    id: 1,
    title: 'BOARD',
    ...
    >
      ...
      {projects.map((project) => (
        <motion.li key={ project.id } className="Project-item" variants={ item } onClick={ () => projectShow(project.id) }>
          <img src={ project.img[0].img } alt={ project.title } ></img>
          <h3>{ project.title }</h3>
